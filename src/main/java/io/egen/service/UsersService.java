...
public interface UsersService {
    ...
    Users findUserByEmailIdAndPassword(String email, String password)			throws UserNotFoundException;

    Users findUserByEmailAndPassword(String email, String password)			throws UserNotFoundException;
